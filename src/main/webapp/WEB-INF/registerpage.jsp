...
<t:genericpage>
    ...
    <jsp:body>
        <div style="margin-top: 5em;" class = "jumbotron jumbotron-fluid">
            <form name="login" action="${pageContext.request.contextPath}/fc/registercommand" method="POST">
                <div class="row mb-3">
                    <label class="col-sm-1 col-form-label" for="email"><foglabeltext>Email</foglabeltext></label>
                    <div class="col-sm-4">
                        <input id="email" class="form-control" type="text" name="email" value="${param.email}" placeholder="Enter a valid email">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-1 col-form-label" for="password1"><foglabeltext>Password</foglabeltext></label>
                    <div class="col-sm-4">
                        <input id="password1" class="form-control" type="password" name="password1"  value="${param.password1}"  placeholder="Enter your password">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-1 col-form-label" for="password2"><foglabeltext>Password</foglabeltext></label>
                    <div class="col-sm-4">
                ...
                <div class="row mb-3">
                    <label class="col-sm-1 col-form-label" for="name"><foglabeltext>Password</foglabeltext></label>
                    <div class="col-sm-4">
