...
public class UserMapperTest {
    ...
    private final static String DATABASE = "fogcarport";  // Change this to your own database
    ...
    public void setUp() {
            ...
            try ( Statement stmt = database.connect().createStatement() ) {
                ...
                stmt.execute(
                    ...
                    "(1,'jens@somewhere.com','jensen','customer','jens'), " +
                    "(2,'ken@somewhere.com','kensen','customer','ken'), " +
                    "(3,'robin@somewhere.com','batman','employee','robin')");
    ...
    public void testCreateUser01() throws UserException {
        ...
        User original = new User( "king@kong.com", "uhahvorhemmeligt", "konge", "kurt" );
